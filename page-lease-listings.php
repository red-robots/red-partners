<?php 
/**
* Template Name: For Lease Listings Page
*/
 get_header(); ?>
...
<div id="framed"><iframe src="http://www.siteindexcharlotte.com/cpelink/index.cfm?LinkID=90&lmethod=Lease" frameborder="0" width="730" height="650"></iframe>		</div>  
