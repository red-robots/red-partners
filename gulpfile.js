...
var project             = 'Red Partners'; // Project Name.
var projecturl          = 'http://localhost/ac/redpartners/'; // Project URL. Could be something like localhost:8888.
...
gulp.task( 'vendorsJs', function() {
	...
	gulp.src( [
		'./assets/js/vendors/jquery.easing.1.3.js',
		'./assets/js/vendors/colorbox.js',
		'./assets/js/vendors/fSelect.js'
		] )
