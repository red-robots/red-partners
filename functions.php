...
//		wp_enqueue_script('jquery');
        wp_register_script('jquery', get_bloginfo('template_directory') . '/assets/js/vendors/jquery.min.js', false, '3.3.1', true);
		wp_enqueue_script('jquery');
		
		// other scripts...
		wp_register_script(
			'vendors',
			get_bloginfo('template_directory') . '/assets/js/vendors.min.js',
			array('jquery') );
		...
		wp_register_script(
			'customjs',
			get_bloginfo('template_directory') . '/assets/js/custom.min.js',
			array('jquery') );
