<?php 
/**
* Template Name: All Available Listings Page
*/
 get_header(); ?>
...
<div id="framed"><iframe src="http://www.siteindexcharlotte.com/cpelink/index.cfm?LinkID=90" frameborder="0" width="730" height="650"></iframe></div>	  
